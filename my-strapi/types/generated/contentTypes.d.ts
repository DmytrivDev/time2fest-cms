...
export interface ApiAboutPageAboutPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    CTO: Schema.Attribute.Component<'about.cto', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    FreePlan: Schema.Attribute.Component<'about.free-plan', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    HeroAbout: Schema.Attribute.Component<'about.hero', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    >;
    PaidPlan: Schema.Attribute.Component<'about.paid-plan', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    publishedAt: Schema.Attribute.DateTime;
    Steps: Schema.Attribute.Component<'about.steps', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    Technic: Schema.Attribute.Component<'about.technic', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Way: Schema.Attribute.Component<'about.way', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    WhyWe: Schema.Attribute.Component<'about.why-we', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiAboutPlatformAboutPlatform extends Struct.SingleTypeSchema {
  collectionName: 'about_platforms';
  info: {
    description: '';
    displayName: 'AboutPlatform';
    pluralName: 'about-platforms';
    singularName: 'about-platform';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    items: Schema.Attribute.Component<'about.about-items', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::about-platform.about-platform'
    >;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiBecomeStreamerBecomeStreamer
  ...
  info: {
    ...
    pluralName: 'become-streamers';
    singularName: 'become-streamer';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    items: Schema.Attribute.Component<'become-streamer.become-streamer', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::become-streamer.become-streamer'
    >;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiFormPageFormPage extends Struct.SingleTypeSchema {
  collectionName: 'form_pages';
  info: {
    displayName: 'FormPage';
    pluralName: 'form-pages';
    singularName: 'form-page';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    FormSeoMeta: Schema.Attribute.Component<'seo.seo-meta', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiHomeHeroSectionHomeHeroSection
  ...
  attributes: {
    ...
    infographik: Schema.Attribute.Component<'hero.hero-infographik', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    minute: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    timer_title: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiHomeSeoMetaHomeSeoMeta extends Struct.SingleTypeSchema {
  collectionName: 'home_seo_metas';
  info: {
    description: '';
    displayName: 'HomeSeoMeta';
    pluralName: 'home-seo-metas';
    singularName: 'home-seo-meta';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    HomeSeoMeta: Schema.Attribute.Component<'seo.seo-meta', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::home-seo-meta.home-seo-meta'
    >;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiLiveStreamLiveStream extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    live_playback_id: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::live-stream.live-stream'
